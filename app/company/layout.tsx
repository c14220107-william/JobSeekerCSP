...
/**
 * Company Layout - Protected Route
 * 
 * This layout wraps all company pages and ensures:
 * 1. User is authenticated (has valid token)
 * 2. User has company role
...
export default function CompanyLayout({
    ...
    const checkAuth = () => {
      try {
        ...
        if (userData.role !== 'company') {
          console.log('User is not company, role:', userData.role);
          setAuthState('forbidden');
          return;
        }

        // All checks passed
        console.log('Company authorization successful');
  ...
  // Wrong role - show 403 Forbidden inline (without company layout)
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center p-4 pt-24">
        <div className="max-w-2xl w-full text-center">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-md mx-auto">
              You don't have permission to access the company panel. Please contact your administrator if you believe this is an error.
            </p>
          </div>
